...
/* src\components\NavLink.svelte generated by Svelte v3.23.2 */
...
const css = {
	...
	map: "{\"version\":3,\"file\":\"NavBar.svelte\",\"sources\":[\"NavBar.svelte\"],\"sourcesContent\":[\"<script>\\r\\n  import NavLink from \\\"./NavLink.svelte\\\";\\r\\n</script>\\r\\n\\r\\n<style>\\r\\n  nav {\\r\\n    margin-bottom: 20px;\\r\\n  }\\r\\n</style>\\r\\n\\r\\n<nav class=\\\"navbar navbar-expand-lg navbar-light bg-light\\\">\\r\\n  <a class=\\\"navbar-brand\\\" href=\\\"/\\\">Navbar</a>\\r\\n  <button\\r\\n    class=\\\"navbar-toggler\\\"\\r\\n    type=\\\"button\\\"\\r\\n    data-toggle=\\\"collapse\\\"\\r\\n    data-target=\\\"#navbarNav\\\"\\r\\n    aria-controls=\\\"navbarNav\\\"\\r\\n    aria-expanded=\\\"false\\\"\\r\\n    aria-label=\\\"Toggle navigation\\\">\\r\\n    <span class=\\\"navbar-toggler-icon\\\" />\\r\\n  </button>\\r\\n  <div class=\\\"collapse navbar-collapse\\\" id=\\\"navbarNav\\\">\\r\\n    <ul class=\\\"navbar-nav\\\">\\r\\n      <li class=\\\"nav-item active\\\">\\r\\n        <!-- <a class=\\\"nav-link\\\" href=\\\"#\\\">\\r\\n          Home\\r\\n          <span class=\\\"sr-only\\\">(current)</span>\\r\\n        </a> -->\\r\\n        <NavLink to=\\\"/\\\">Home</NavLink>\\r\\n\\r\\n      </li>\\r\\n      <li class=\\\"nav-item\\\">\\r\\n        <NavLink to=\\\"/about\\\">About</NavLink>\\r\\n      </li>\\r\\n      <li class=\\\"nav-item\\\">\\r\\n        <NavLink to=\\\"/blog\\\">Blog</NavLink>\\r\\n      </li>\\r\\n      <!-- <li class=\\\"nav-item\\\">\\r\\n        <a\\r\\n          class=\\\"nav-link disabled\\\"\\r\\n          href=\\\"#\\\"\\r\\n          tabindex=\\\"-1\\\"\\r\\n          aria-disabled=\\\"true\\\">\\r\\n          Disabled\\r\\n        </a>\\r\\n      </li> -->\\r\\n    </ul>\\r\\n  </div>\\r\\n</nav>\\r\\n\"],\"names\":[],\"mappings\":\"AAKE,GAAG,eAAC,CAAC,AACH,aAAa,CAAE,IAAI,AACrB,CAAC\"}"
};

const NavBar = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `<nav class="${"navbar navbar-expand-lg navbar-light bg-light svelte-143j9lh"}"><a class="${"navbar-brand"}" href="${"/"}">Navbar</a>
  <button class="${"navbar-toggler"}" type="${"button"}" data-toggle="${"collapse"}" data-target="${"#navbarNav"}" aria-controls="${"navbarNav"}" aria-expanded="${"false"}" aria-label="${"Toggle navigation"}"><span class="${"navbar-toggler-icon"}"></span></button>
  <div class="${"collapse navbar-collapse"}" id="${"navbarNav"}"><ul class="${"navbar-nav"}"><li class="${"nav-item active"}">
        ${validate_component(NavLink, "NavLink").$$render($$result, { to: "/" }, {}, { default: () => `Home` })}</li>
      <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { to: "/about" }, {}, { default: () => `About` })}</li>
      <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { to: "/blog" }, {}, { default: () => `Blog` })}</li>
      </ul></div></nav>`;
});
...
/* src\routes\Blog.svelte generated by Svelte v3.23.2 */
...
const App = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"container"}">${validate_component(Route, "Route").$$render($$result, { path: "about", component: About }, {}, {})}
