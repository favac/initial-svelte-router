...
(function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	return {
    		...
    		l(nodes) {
    			...
    			claim_component(navlink0.$$.fragment, li0_nodes);
    			li0_nodes.forEach(detach);
    			t3 = claim_space(ul_nodes);
    			li1 = claim_element(ul_nodes, "LI", { class: true });
    			var li1_nodes = children(li1);
    			claim_component(navlink1.$$.fragment, li1_nodes);
    			li1_nodes.forEach(detach);
    			t4 = claim_space(ul_nodes);
    			li2 = claim_element(ul_nodes, "LI", { class: true });
    			var li2_nodes = children(li2);
    			claim_component(navlink2.$$.fragment, li2_nodes);
    		...
    		h() {
    			...
    			attr(nav, "class", "navbar navbar-expand-lg navbar-light bg-light svelte-143j9lh");
    		},
    		m(target, anchor) {
    ...
    class App extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$8, safe_not_equal, { url: 0 });
    	}
    }
